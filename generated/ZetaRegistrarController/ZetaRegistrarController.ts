...
export class ZetaRegistrarController__rentPriceResultPriceStruct extends ethereum.Tuple {
  get base(): BigInt {
...
export class ZetaRegistrarController extends ethereum.SmartContract {
  static bind(address: Address): ZetaRegistrarController {
    return new ZetaRegistrarController("ZetaRegistrarController", address);
  }
  ...
  rentPrice(
    name: string,
    duration: BigInt
  ): ZetaRegistrarController__rentPriceResultPriceStruct {
    let result = super.call(
      "rentPrice",
    ...
    return changetype<ZetaRegistrarController__rentPriceResultPriceStruct>(
      result[0].toTuple()
    );
  }
  ...
  try_rentPrice(
    name: string,
    duration: BigInt
  ): ethereum.CallResult<ZetaRegistrarController__rentPriceResultPriceStruct> {
    let result = super.tryCall(
      "rentPrice",
      "rentPrice(string,uint256):((uint256,uint256))",
      [
    ...
    return ethereum.CallResult.fromValue(
      changetype<ZetaRegistrarController__rentPriceResultPriceStruct>(
        value[0].toTuple()
      )
    );
  }
